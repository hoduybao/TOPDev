...
import { Button, Form, Input, Select, Spin, type FormProps } from 'antd';
...
const Profile = () => {
  ...
  const { data, isFetching } = useGetCompanyProfileQuery();
  ...
  const onEditFinish = async () => {
    ...
    const values = CompanyProfileForm.getFieldsValue();
    ...
    updateCompanyProfile(ProfileBody)
      .unwrap()
      .then(() => {
        setOpenModal(false);
      });
      ...
      >
        ...
        <section className='mt-10 grid xl:grid-cols-2 gap-x-[50px] gap-y-4'>
          ...
          >
            <div>
              <p className='mb-3'>
                Tell job seekers about your company. Your description will appear in the About
                company tab
              </p>
        ...
        <section className='mt-10 flex flex-wrap gap-4 items-center justify-between'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <Button loading={isFetching} type='primary' htmlType='submit' danger>
        ...
        <ConfirmModal
          ...
          handleOk={onEditFinish}
          isLoadingBtn={updateProfileLoading}
        >
