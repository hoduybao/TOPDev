...
export const mockJobData: Job[] = [
  {
    ...
    technicals: ['JavaScript', 'React', 'Node.js'],
  ...
  },
  {
    ...
    technicals: ['Python', 'Machine Learning', 'SQL'],
  ...
  },
  {
    ...
    technicals: ['Product Management', 'Market Analysis', 'Communication'],
  ...
  },
  {
    ...
    technicals: ['HTML', 'CSS', 'JavaScript', 'React'],
  ...
  },
  {
    ...
    technicals: ['SQL', 'Data Visualization', 'Statistical Analysis'],
  ...
  },
  {
    ...
    level: 'Mid',
    salary: '$80,000 - $100,000',
    technicals: ['Java', 'Spring', 'Hibernate'],
    experienceYearsMin: '3',
    experienceYearsMax: '5',
    typeContract: 'Contract',
    type: 'Temporary',
  ...
  },
  {
    ...
    level: 'Senior',
    salary: '$90,000 - $110,000',
    technicals: ['Marketing Strategy', 'Brand Management', 'Market Research'],
    experienceYearsMin: '5',
    experienceYearsMax: '8',
    typeContract: 'Full-time',
    type: 'Permanent',
  ...
  },
  {
    ...
    level: 'Mid',
    salary: '$80,000 - $100,000',
    technicals: ['Python', 'Django', 'MySQL'],
    experienceYearsMin: '3',
    experienceYearsMax: '5',
    typeContract: 'Full-time',
    type: 'Permanent',
  ...
  },
  {
    ...
    level: 'Mid',
    salary: '$90,000 - $110,000',
    technicals: ['Big Data', 'Hadoop', 'Spark'],
    experienceYearsMin: '4',
    experienceYearsMax: '6',
    typeContract: 'Contract',
    type: 'Temporary',
  ...
  },
  {
    ...
    level: 'Junior',
    salary: '$60,000 - $80,000',
    technicals: ['Manual Testing', 'Automated Testing', 'Bug Tracking'],
    experienceYearsMin: '1',
    experienceYearsMax: '3',
    typeContract: 'Contract',
    type: 'Temporary',
