...
export const cities = [
  ...
  { value: 'Thành phố Thừa Thiên Huế', label: 'Thành phố Thừa Thiên Huế' },
];
...
export const districts = [
  ...
  { value: 'Quận Củ Chi', label: 'Quận Củ Chi' },
  { value: 'Quận Hóc Môn', label: 'Quận Hóc Môn' },
  { value: 'Quận Bình Chánh', label: 'Quận Bình Chánh' },
  { value: 'Quận Nhà Bè', label: 'Quận Nhà Bè' },
  { value: 'Quận Cần Giờ', label: 'Quận Cần Giờ' },
];
...
export const wards = [
  ...
  { value: 'Phường Bến Thành', label: 'Phường Đa Thành' },
