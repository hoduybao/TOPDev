...
const NavBar = ({ isCollapsed }: NavBarProps) => {
  ...
  return (
    <div className='bg-white-900 h-full pt-5'>
      <Menu
        style={{ width: isCollapsed ? '104px' : '265px' }}
        theme='light'
        mode='inline'
        inlineCollapsed={isCollapsed}
        defaultSelectedKeys={
          route == MY_ROUTE.ADMIN || route == MY_ROUTE.ADMIN + '/'
            ? [MY_ROUTE.ADMIN_ACCOUNT_MANAGEMENT]
            : [route]
        }
        ...
        items={[
          {
            ...
            label: <span className='text-base'>Manage Accounts</span>,
          },
          {
            ...
            label: <span className='text-base'>Manage Jobs</span>,
          },
        ]}
      />
    </div>
